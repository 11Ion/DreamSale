// Codul pentru animațiile pe bază de scroll
...
function initializeSelectItems() {
  ...
  const valueItems = document.getElementById('value_items');
  ...
  selectItems.addEventListener('click', function() {
      if (elementItems.style.display === 'block') {
  ...
  options.forEach(function(option) {
      option.addEventListener('click', function() {
          valueItems.textContent = option.textContent;
          elementItems.style.display = 'none';
      });
  });
}
